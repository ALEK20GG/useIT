...
<main class="page page-transition">
  ...
  <section class="test-section">
    ...
    <div class="demo-grid">
      <button class="btn btn-primary" onclick={simulateLoading} disabled={loading}>
        {#if loading}
          <span class="spinner spinner-sm"></span>
  ...
  {#if showModal}
    ...
    >
      <div
        class="modal-content slide-in-up"
        role="dialog"
        aria-modal="true"
        tabindex="-1"
      ...
      >
        <div class="modal-header">
          <h2 id="modal-test-title">Modal di Test</h2>
          <button class="close-button" onclick={() => showModal = false} aria-label="Chiudi modal">✕</button>
        </div>
