    ...
    <nav class="help-nav" aria-label="Sezioni della guida">
      {#each sections as section}
        ...
        >
          ...
          <span>{t(`help.section.${section.id}`)}</span>
        </button>
      {/each}
    </nav>
      ...
      {:else if activeSection === 'api'}
        <article class="help-article fade-in">
          ...
          <div class="endpoint-list">
            ...
            <div class="endpoint">
              <span class="method method-post">POST</span>
              <code>/pdf/upload</code>
              <p>Carica e indicizza un documento PDF.</p>
            </div>
            <div class="endpoint">
              <span class="method method-post">POST</span>
              <code>/semantic/search</code>
              <p>Esegue una ricerca semantica nella collezione specificata.</p>
            </div>
            <div class="endpoint">
